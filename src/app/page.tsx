  ...
  return (
    <main className="container max-w-2xl mx-auto px-4 py-8" style={{ marginTop: '30px' }}>
      <div className="flex flex-col items-center justify-center gap-6">
        ...
        <p className="text-muted-foreground sm:text-[10px] md:text-md text-center max-w-md">
          Make your selections before Aug 15th at 7pm
        </p>
        <div className="sm:text-[10px] md:text-md flex gap-4">
      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        <div className="sm:mt-16 md:mt-24 lg:mt-24 sm:text-[10px] md:text-md flex gap-4">
          <p>Brought to you by <span className="text-red-600 font-bold"> Dont Be aC*nt productions</span></p>
        </div>
      </div>
    </main>
  );
